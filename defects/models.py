...
class DefectReport(models.Model):
    ...
    approved_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='approved_defects')
    approved_at = models.DateTimeField(null=True, blank=True)
    backlog_item_link = models.CharField(max_length=100, blank=True, null=True)

    rejected_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='rejected_defects')
    rejected_at = models.DateTimeField(null=True, blank=True)
    rejection_reason = models.TextField(blank=True, null=True)

    reopened_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='reopened_defects')
    ...
    cannot_reproduced_by = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True, blank=True, related_name='cannot_reproduced_defects')
...
class Comment(models.Model):
    """Comments attached to a defect report."""
    defect_report = models.ForeignKey(DefectReport, on_delete=models.CASCADE, related_name='comments')
